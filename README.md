...
1. Simple version, you dont need do nothing, you will get only 1 sessions (System)
Example command:
...
2. Advanced version, code will ask you some questions to make it more custom
Example command:
...
3. Script version, all in one code by arguments ( You need set it on this order: "Version (0,1,2)" "Token" "Number of sessions" "MaxCpu ussage (Dont use %, just number)
Example command:
